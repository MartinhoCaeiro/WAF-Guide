...
Na secção 2, iremos escolher o servidor host, cujo qual vai ser o endereço de cada um dos sites:
\begin{itemize}
    \item \textbf{http://www1.trinta.org}
    \item \textbf{http://www1.3emfrente.eu}
    \item \textbf{http://www1.the.com}
\end{itemize}
...
Na secção 6 iremos adicionar IPs à nossa Blacklist, no nosso caso iremos adicionar o IP \textbf{...adicionar ip...}
que é proveniente da maquina Kali Linux.
